function [DistanceVal] = Derivative_DynamicTimeWarping(Data_Ref,Data_Target)

% Implementatoin of the paper : 
% Eamonn J. Keogh, M. J. P. (2000). Scaling up dynamic time warping for 
% datamining applications. KDD, 285–289.


%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% This function is used for calculating Derivative Dynamic Time Warping between two
...
% Commented due to the use of UCR dataset as in this dataset, the data is
