function [DistanceVal] = ValueDerivative_DTW(Data_Ref,Data_Target)

% Implementatoin of the paper : 
% Kulbacki, M., Kulbacki, M., Segen, J., Segen, J., Bak, A., & Bak, A. 
% (2002). Unsupervised Learning Motion Models Using Dynamic 
% Time Warping. Systems Research, July 2015, 1–10.
